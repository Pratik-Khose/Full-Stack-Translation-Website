...
<div class="hero_area">
  ...
  <section class="service_section layout_padding">
    <div class="container-fluid">
      ...
      <div class="service_container">
        <div class="box">
          <a href="txttospeech\index.html" class="link-hover"> <!-- Add hyperlink to about.html -->
              <div class="img-box">
                  <img src="pages/images/s-1.png" alt="Image-to-Text Conversion">
              </div></a>
              <div class="detail-box">
                  <h5>
      ...
      <div class="box">
        <a href="Text-Translation\index.html" class="link-hover"> <!-- Add hyperlink to about.html -->
            <div class="img-box">
                <img src="pages/images/s-2.png" alt="Image-to-Text Conversion">
            </div></a>
            <div class="detail-box">
                <h5>
    ...
    <div class="box">
      <a href="Text-Editor\index.html" class="link-hover"> <!-- Add hyperlink to about.html -->
          <div class="img-box">
              <img src="pages/images/s-3.png" alt="Image-to-Text Conversion">
          </div></a>
          <div class="detail-box">
            <h5>
  ...
  <div class="box">
    <a href="txttospeech\index.html" class="link-hover"> <!-- Add hyperlink to about.html -->
        <div class="img-box">
            <img src="pages/images/s-4.png" alt="Image-to-Text Conversion">
        </div></a>
        <div class="detail-box">
            <h5>
                Image-to-Text Conversion
            ...
            <p>
                At [Your Website Name], we understand that valuable information can be locked within images and scanned documents. With our state-of-the-art OCR (Optical Character Recognition) technology, we make it effortless to extract text from images while preserving the original formatting and layout.
            </p>
        </div>
...
<div class="box">
  <a href="fun-img\image.html" class="link-hover"> <!-- Add hyperlink to about.html -->
      <div class="img-box">
          <img src="pages/images/s-5.png" alt="Image-to-Text Conversion">
      </div></a>
      <div class="detail-box">
          <h5>
              Fun Text Image
...
<div class="box">
  <a href="speech-text\index.html" class="link-hover"> <!-- Add hyperlink to about.html -->
      <div class="img-box">
          <img src="pages/images/s-6.png" alt="Image-to-Text Conversion">
      </div></a>
      <div class="detail-box">
          <h5>
          ...
          <p>
              Get a hands on free experience of typing in the any langugae you want and just by your vocals.
          </p>
      </div>
...
<div class="box">
  <a href="voice-mani\Voice-mani.html" class="link-hover"> <!-- Add hyperlink to about.html -->
      <div class="img-box">
          <img src="pages/images/s-7.png" alt="Image-to-Text Conversion">
      </div></a>
      <div class="detail-box">
          <h5>
              Text-to-Voice
...
<div class="box">
  <a href="txttospeech\index.html" class="link-hover"> <!-- Add hyperlink to about.html -->
      <div class="img-box">
          <img src="pages/images/s-8.png" alt="Image-to-Text Conversion">
      </div></a>
      <div class="detail-box">
        <h5>
          Powerful Text Editing
  ...
  <section class="work_section layout_padding">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="img-box">
            <img src="pages/images/work-img.png" alt="">
          </div>
        </div>
      </div>
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <div class="container">
            <div class="box">
              <div class="img-box">
                <img src="pages/images/client.png" alt="">
              </div>
              <div class="detail-box">
                <h6>
                  Hariom Ingle
          ...
          <div class="container">
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <p>
                  As a coder, I have a deep appreciation for efficient and practical tools that simplify tasks and enhance productivity. [Your Website Name] is a platform that has earned its place as a critical component of my coding toolkit.
          ...
          <div class="container">
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <p>
                  As a student, juggling assignments, projects, and presentations can be overwhelming. But then, I discovered [Your Website Name], and it quickly became my academic lifesaver.For my language studies, the multilingual support provided by [Your Website Name] is a game-changer. It's amazing how I can easily translate and edit text into different languages, making my language assignments and research projects a breeze.
                </p>
                <img src="pages/images/quote.png" alt="">
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="info_form ">
              ...
              <div class="social_box">
                <a href="">
                  <img src="pages/images/info-fb.png" alt="">
                </a>
                <a href="">
                  <img src="pages/images/info-twitter.png" alt="">
                </a>
                <a href="">
                  <img src="pages/images/info-linkedin.png" alt="">
                </a>
                <a href="">
                  <img src="pages/images/info-youtube.png" alt="">
                </a>
              </div>
            </div>
          </div>
